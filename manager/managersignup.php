   ...
   <h3>Restaurant Signup</h3>
    ...
    <div class="container" style="margin-top: 2%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"> Create Restaurant Account </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="c_password"><span class="text-danger" style="margin-right: 5px;">*</span> Confirm Password: </label>
            <div class="input-group">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class=" fa fa-lock" aria-hidden="true"></span></label>
            </span>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              <li><a href="index.php">Restaurant Login</a></li>
              <li><a href="managersignup.php">Restaurant Signup</a></li>
